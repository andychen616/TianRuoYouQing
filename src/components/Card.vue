<template>
  ...
  <a :href="item.url" target="_blank" 
     class="card-container flex items-start bg-white dark:bg-gray-700 backdrop-blur-light p-3 sm:p-4 rounded shadow-md transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] border-2 border-transparent relative h-full">
